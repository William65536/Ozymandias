...
static Solid *Solid_primitive_new(Vec3 pos, Dim3 dim, Rot3 rot, Luminosity (*primitive_luminosity)(const Solid *, Ray))
{
...
static Solid *Solid_composite_new(Solid *left, Solid *right, Luminosity (*composite_luminosity)(const Solid *, Ray))
{
    assert(left != NULL);
    assert(right != NULL);
